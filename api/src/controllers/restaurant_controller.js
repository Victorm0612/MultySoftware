...
export async function create(req,res){
    const { restaurant_name, restaurant_address, phone, attention_time, restaurant_status } = req.body
    try {
...
export async function updateRestaurant(req,res){
    ...
    const restaurantFound = await models.Restaurant.findAll({
        attributes: ['restaurant_name','restaurant_address','phone','attention_time','restaurant_status'],
        where: {
            id: id
        }
    })

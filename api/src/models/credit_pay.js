  ...
  class Credit_Pay extends Model {
    ...
    static associate(models) {
      ...
      */
      ...
      models.Card.hasMany(models.Credit_Pay, { as: "CreditCard", foreignKey: "card_number"})

      //Credit_pay belongs to one Card
      models.Credit_Pay.belongsTo(models.Card, { as: "CreditCard", foreignKey: "card_number"})

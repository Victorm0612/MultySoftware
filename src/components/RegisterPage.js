    ...
    <div className={classes.register}>
      <Card>
        ...
        <form className={classes["form-control"]}>
          ...
          <input required id="name__input" type="text" />
          <label htmlFor="last_name__input">Apellido</label>
          <input required id="last_name__input" type="text" />
          <label htmlFor="document-type__input">Tipo de documento</label>
          <select required id="document-type__input">
          ...
          <input required id="password__input" type="password" minLength="8" />
